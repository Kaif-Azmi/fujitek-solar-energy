...
/**
 * Public user login — for optional customer/site user accounts.
 * Not for admin access; admin uses /admin/login (URL-only).
 */
export default function UserLoginPage() {
  ...
  useEffect(() => {
    ...
    const friendly: Record<string, string> = {
      ...
      OAuthAccountNotLinked: 'This account is not linked. Try signing in with email.',
