...
export const Lightning = ({ className = "" }: IconProps) => (
  <span className={`icon icon--energy ${className}`} aria-hidden="true">
...
export const Handshake = ({ className = "" }: IconProps) => (
  <span className={`icon icon--solar ${className}`} aria-hidden="true">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
export const MapPin = ({ className = "" }: IconProps) => (
  <span className={`icon icon--neutral ${className}`} aria-hidden="true">
    <svg viewBox="0 0 24 24" fill="currentColor">
...
export const Sun = ({ className = "" }: IconProps) => (
  <span className={`icon icon--solar ${className}`} aria-hidden="true">
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M6.76 4.84l-1.8-1.79L4 4.01l1.79 1.8zM1 13h3v-2H1zm10 9h2v-3h-2zm7.24-1.84l.97.97L20 19.16l-.97-.97zM17 13h3v-2h-3zM6.76 19.16l-.97.97L8 20.99l.97-.97zM12 7a5 5 0 100 10 5 5 0 000-10z" />
    </svg>
  </span>
);
