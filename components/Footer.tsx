      ...
      <div className="relative mx-auto max-w-7xl px-6 py-14 sm:py-16">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3 md:gap-12">
          ...
          <section aria-label="Contact information">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-200">Contact</h3>

            <div className="mt-4 space-y-3">
              <a
                href={`tel:${PHONE_NUMBER}`}
                className="relative inline-flex w-fit items-center gap-2 text-sm text-slate-100 transition hover:text-accent after:absolute after:-inset-y-2 after:-inset-x-1 after:content-['']"
              >
